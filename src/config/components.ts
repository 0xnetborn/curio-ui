...
export const components: ComponentMeta[] = [
    ...
    {
        slug: "text-animations/a-s-c-i-i-text",
        name: "ASCIIText",
...
,
    {
        slug: "text-animations/animated-content",
        name: "AnimatedContent",
        description: "AnimatedContent animation effect",
        category: "text",
        isPremium: false,
        isNew: true,
    },,
    ...
    {
        slug: "text-animations/click-spark",
        name: "ClickSpark",
        description: "ClickSpark animation effect",
        category: "text",
        isPremium: false,
        isNew: true,
    },,
    ...
    {
        slug: "text-animations/falling-text",
        name: "FallingText",
    ...
    },,
    {
        slug: "text-animations/fuzzy-text",
        name: "FuzzyText",
        description: "FuzzyText animation effect",
        category: "text",
        isPremium: false,
        isNew: true,
    },,
    ...
    {
        slug: "text-animations/shiny-text",
        name: "ShinyText",
        description: "ShinyText animation effect",
        category: "text",
        isPremium: false,
        isNew: true,
    },,
    ...
    },,
    {
        slug: "text-animations/text-pressure",
        name: "TextPressure",
        description: "TextPressure animation effect",
        category: "text",
        isPremium: false,
        isNew: true,
    },,
