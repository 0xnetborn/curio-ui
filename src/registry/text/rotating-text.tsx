    ...
    >
      ...
      <AnimatePresence mode={animatePresenceMode} initial={animatePresenceInitial}>
        <motion.span
          ...
          className={cn(splitBy === 'lines' ? 'flex flex-col' : 'inline-flex flex-wrap whitespace-pre-wrap relative')}
          layout
          aria-hidden="true"
        >
          {elements.map((wordObj, wordIndex, array) => {
            ...
            return (
              <span key={wordIndex} className={cn('inline-flex', splitLevelClassName)}>
                ...
                {wordObj.needsSpace && <span className="inline-block w-[0.3em]"> </span>}
              </span>
            );
          })}
        </motion.span>
