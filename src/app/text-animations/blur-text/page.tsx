  ...
  return (
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
        ...
        <p className="text-muted-foreground max-w-lg">Text that reveals with a blur effect.</p>
      </motion.div>

      <PreviewCodeUsageTabs
        preview={
          <div className="flex items-center justify-center min-h-[200px] w-full bg-background border rounded-lg p-8">
            <BlurText
              text="Isn't this so cool?!"
              delay={150}
              animateBy="words"
