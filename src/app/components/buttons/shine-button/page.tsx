...
const ShineButton = ({
  ...
  return (
    <button
      className={\\\`relative overflow-hidden rounded-lg bg-slate-800 px-6 py-2.5 font-semibold text-white transition-colors hover:bg-slate-700 \${className}\\\`}
      {...props}
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-4 text-center lg:text-left">
          ...
          <div>
            <h1 className="text-4xl lg:text-6xl font-black italic tracking-tighter uppercase leading-[0.8]">
              SHINE <span className="text-yellow-500">BUTTON</span>
            </h1>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between py-3 px-4">
                  <CardTitle className="flex items-center gap-2 text-xs">
                    {codeTab === "usage" ? <Play className="w-4 h-4 text-yellow-500" /> : <FileCode className="w-4 h-4 text-muted-foreground" />}
