...
export const WetButton = ({
  ...
  return (
    <button
      className={cn("group relative rounded bg-accent px-6 py-3 font-semibold text-accent-foreground transition-colors hover:bg-accent/90", className)}
      {...props}
    >
      {children}
  ...
  return (
    ...
    >
      ...
      <svg width="6" height="6" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg" className={cn("absolute right-full top-0 rotate-90", colorClass, groupHoverClass)}>
        ...
        <defs><clipPath id="clip0_1077_28_2"><rect width="6" height="6" fill="white" /></clipPath></defs>
      </svg>
      <motion.div
  ...
  return (
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
        ...
        <p className="text-muted-foreground max-w-lg">A button with dripping paint effect on hover.</p>
      </motion.div>
