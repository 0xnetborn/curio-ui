...
import Lightning from "@/registry/text/lightning";
...
const usageCode = `import Lightning from "@/registry/text/lightning";

<Lightning text="CurioUI" />`;
    ...
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-display text-4xl font-bold">Lightning</h1>
        </div>
        <p className="text-muted-foreground max-w-lg">Lightning animation effect.</p>
      </motion.div>
