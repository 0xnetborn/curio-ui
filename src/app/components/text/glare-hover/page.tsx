...
import GlareHover from "@/registry/text/glare-hover";
...
const usageCode = `import GlareHover from "@/registry/text/glare-hover";

<GlareHover text="CurioUI" />`;
    ...
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-display text-4xl font-bold">GlareHover</h1>
        </div>
        <p className="text-muted-foreground max-w-lg">GlareHover animation effect.</p>
      </motion.div>
