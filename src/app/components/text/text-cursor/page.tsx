...
import TextCursor from "@/registry/text/text-cursor";
...
const usageCode = `import TextCursor from "@/registry/text/text-cursor";

<TextCursor text="CurioUI" />`;
  ...
  return (
    <div className="space-y-8">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-4">
        ...
        <p className="text-muted-foreground max-w-lg">TextCursor animation effect.</p>
      </motion.div>
