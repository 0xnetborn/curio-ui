...
const componentCode = `import { forwardRef, useMemo, useRef, useEffect } from 'react';
import { motion } from 'framer-motion';
  ...
  return (
    <div className="space-y-8">
      ...
      <PreviewCodeUsageTabs
        preview={
          <div className="flex items-center justify-center min-h-[200px]" ref={(el) => {
            // VariableProximity requires specific font variation settings
          }}>
            <VariableProximity 
              label="CurioUI" 
              fromFontVariationSettings="'wght' 400"
