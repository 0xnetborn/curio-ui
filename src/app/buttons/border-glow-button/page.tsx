...
export default function BorderGlowButtonPage() {
  return (
    <div className="space-y-8">
      ...
      <p className="text-muted-foreground max-w-2xl">Button with mouse-tracking glow effect on border.</p>
      ...
      <div className="rounded-xl border border-border bg-card p-6 space-y-4">
        ...
        <pre className="bg-muted p-4 rounded-lg overflow-x-auto text-sm font-mono">{`import BorderGlowButton from "@/registry/buttons/border-glow-button";
