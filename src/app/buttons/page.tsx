    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-lg">
          Beautiful animated buttons with hover effects. Click any button to
          view the code and preview.
        </p>
      </motion.div>
          ...
          >
            <Link href={`/buttons/${button.name}`}>
              <div className="group relative aspect-square rounded-xl border border-border bg-card p-6 transition-all hover:border-accent/50 hover:shadow-lg hover:shadow-accent/10">
                ...
                {/* Hover effect - the button plays on hover */}
                <div
                  className="absolute inset-0 opacity-0 transition-opacity group-hover:opacity-100 rounded-xl cursor-pointer"
                  onMouseEnter={(e) => {
                    // Trigger the button hover effect via keyboard simulation
